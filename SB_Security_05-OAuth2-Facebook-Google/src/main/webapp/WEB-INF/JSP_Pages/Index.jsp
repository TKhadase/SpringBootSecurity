					...
					<div class="card2 card border-0 px-4 py-5">
						<div class="row mb-4 px-3">
							...
							<div class="facebook text-center mr-3">
								<a href="/SB_Security_05-OAuth2-Facebook-Google/oauth2/authorization/facebook"><div class="fa fa-facebook"> </div></a>
							</div>
							<div class="twitter text-center mr-3">
								<a href="/SB_Security_05-OAuth2-Facebook-Google/oauth2/authorization/google"><div class="fa fa-google-plus"></div></a>
							</div>
